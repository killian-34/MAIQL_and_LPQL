...
datatype='eng14'
SAVENAME="eng14_2_7_3"
FILE_ROOT='/n/holylfs/LABS/tambe_lab/jkillian/maiql'
NLAMS=3000
GAMMA=0.95

python3 ${cdir}/ma_rmab_online_simulation.py -pc ${1} -l ${SIMULATION_LENGTH} -d ${datatype} -s 0 -ws 0 -sv ${SAVENAME} -sid ${SLURM_ARRAY_TASK_ID} --file_root ${FILE_ROOT} --n_lams ${NLAMS} -g ${GAMMA} -lr 1 --config_file config_eng14.csv
